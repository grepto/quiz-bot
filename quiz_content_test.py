...
expected_quiz = [(
    'Злодей из пакистанского фильма 1990 года подвергает героев особой пытке- заставляет прослушивать аудиозапись своих произведений. Назовитефамилию этого злодея.',
    'рушди'), (
    'Он родился в 1828 году. Закончил институт с отличием, преуспел в научнойдеятельности, имел множество публикаций. Однако в русском языке егофамилия стала обозначать человека, не блещущего умственнымиспособностями. Назовите эту фамилию.',
    'даун'), (
    '<раздатка>Одним из горячо обсуждаемых вопросов была проблема смешанныхеврейско-арабских браков.</раздатка>Перед вами цитата из статьи Википедии о конференции, состоявшейся всередине XX века. Какие две буквы мы заменили в этой цитате?',
    'ий'), (
    'В советском мультфильме 1979 года усатый человек поднимает с землипредмет, который много веков пролежал в забвении. Назовите фамилию этогочеловека.',
    'кубертен')]
